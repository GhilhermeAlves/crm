 ...
 * + checagem central de tenant (@CurrentCompanyId) + TenantContext garantem
...
public class CampaignController {
    ...
    public ResponseEntity<PageResponse<CampaignResponse>> list(
            @CurrentCompanyId("Você só pode acessar campanhas da sua própria empresa.") UUID companyId,
    ...
    @PreAuthorize("hasAuthority('campaign:update')")
    public ResponseEntity<CampaignResponse> attachChannel(
            @CurrentCompanyId("Você só pode acessar campanhas da sua própria empresa.") UUID companyId,
            @PathVariable UUID campaignId,
    ...
    @PreAuthorize("hasAuthority('campaign:execute')")
    public ResponseEntity<ExecutionResponse> executeNow(
            @CurrentCompanyId("Você só pode acessar campanhas da sua própria empresa.") UUID companyId,
            @PathVariable UUID campaignId,
            @AuthenticationPrincipal CurrentUser principal) {
