 ...
 * ({@code app.current_company_id} / {@code app.current_keycloak_sub} /
 * {@code app.current_identity_email}) a cada conexão obtida, para que o RLS
 * FORCE do banco CRM funcione também com o usuário {@code crm_app}
 * (NOBYPASSRLS).
 */
