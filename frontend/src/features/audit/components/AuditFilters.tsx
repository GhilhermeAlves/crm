...
const MODULES = [
  ...
  "CUSTOMERS", "CONTACTS", "LEADS", "PIPELINE", "TASKS",
  "CALENDAR", "FINANCE", "REPORTS", "SETTINGS", "AUDIT", "SYSTEM",
];

const ACTIONS = [
  "CREATE", "READ", "UPDATE", "DELETE", "LOGIN", "LOGOUT",
  "EXPORT", "IMPORT", "APPROVE", "REJECT", "ASSIGN", "UNASSIGN",
  "RESET_PASSWORD", "CHANGE_PASSWORD", "GENERATE_REPORT",
];
...
export function AuditFilters({ params, onParamsChange }: AuditFiltersProps) {
  ...
  const hasActiveFilters = params.module || params.action || params.status || params.search || params.startDate || params.endDate;
