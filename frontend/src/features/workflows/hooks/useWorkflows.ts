...
export function useWorkflow(
  ...
  return useQuery({
    ...
    queryFn: () =>
      WorkflowService.findById(companyId as string, workflowId as string),
...
export function useWorkflowExecutions(
  ...
  return useQuery({
    ...
    queryFn: () =>
      WorkflowService.executions(companyId as string, workflowId as string),
    enabled: !!companyId && !!workflowId,
  });
}
...
export function useCreateWorkflow(companyId: string | null) {
  ...
  return useMutation({
    mutationFn: (data: CreateWorkflowRequest) =>
      WorkflowService.create(companyId as string, data),
    onSuccess: () => {
